...
ModuleSceneEnd::ModuleSceneEnd(Application* app, bool start_enabled) : ModuleScene(app, start_enabled)
{
}

void ModuleSceneEnd::LoadPositions()
{
	neutralNum = 111;
