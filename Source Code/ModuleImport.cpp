...
bool ModuleImport::Init()
{
	...
	const aiScene* file = aiImportFileEx("Assets/Models/Street_environment_V01.FBX", aiProcessPreset_TargetRealtime_MaxQuality, App->fileSystem->GetAssimpIO());
	if (file)
	{
		LOG("File found");
		LoadFBX(file, file->mRootNode, App->scene->GetRoot(), "Assets/Models/Street_environment_V01.FBX");
